...
def main():
    ...
    for dataset in DATASETS:
        ...
        for frac in DATA_FRACTIONS:
            ...
            lin_test_auc, lin_test_acc, lin_hist = train_finetune_model(linear_model, train_loader, val_loader, test_loader, device, dataset, f"Linear_{frac}")
            mlp_test_auc, mlp_test_acc, mlp_hist = train_finetune_model(mlp_model, train_loader, val_loader, test_loader, device, dataset, f"MLP_{frac}")
